...
const Signup = () => {
  ...
  const handleSignup = async (event) => {
    ...
    if (!fullName || !email || !phoneNumber || !password || !retypePassword) {
    ...
    try {
      // Gọi API đăng ký
      let res = await signupApi({ full_name: fullName, email, phone_number: phoneNumber, password, retype_password: retypePassword, role_id: 2 });
      console.log(res);
